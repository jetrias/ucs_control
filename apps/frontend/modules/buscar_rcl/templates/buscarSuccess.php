...
<br>
  ...
  <div class="modal-body"><p><br>
    <!--p>SE LES REITERA QUE A PARTIR DEL DÍA MIERCOLES 22 DE MARZO DE 2017,EL REGISTRO ESTARÁ ABIERTO   PARA TODAS Y TODOS LOS ESTUDIANTES ACTIVOS
(Estudiantes regulares, reingresos,repitientes)  
</p-->
...
<div id="sf_admin_container" class="sf_admin_edit ui-widget ui-widget-content ui-corner-all">
    ...
    <br/>
        <div class="ui-corner-all ui-tabs-panel ui-widget-content ui-corner-bottom">
            <br/><br/>
            <form method="POST" action="/control/index.php/buscar_rcl/buscar_rcl" name="buscarForm" id="buscarForm" onSubmit="return enviar()" autocomplete="off">
                <center><table>
                        <tr><td colspan="3"> &nbsp;
                        ...
                        <tr><td>Tipo de Identificaci&oacute;n</td><td><select name="tipo_doc" id="tipo_doc">
                                    <option value="">Seleccione</option>
                                    <option value="V">V</option>
                                    <option value="E">E</option>
                                    <option value="P">P</option>
                                </select></td><td><input type="text" name="identificacion" id="identificacion" placeholder="Número de identificación"></td></tr>
                        <tr>
                            <td>C&oacute;digo de Verficaci&oacute;n</td><td><?php echo '<img src="module' . $_SESSION['captcha']['image_src'] . '" alt="CAPTCHA code">'; ?></td>
                            <td><input type="text" name="codigo" id="codigo" placeholder="Código de verificación"><br/> No se distingue entre mayúsculas y minúsculas</td></tr>
