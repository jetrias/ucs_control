...
//
function simple_php_captcha($module='',$config = array()) {
    ...
    if ( strpos($_SERVER['SCRIPT_FILENAME'], $_SERVER['DOCUMENT_ROOT']) ) {
        $image_src = substr(__FILE__, strlen( realpath($_SERVER['DOCUMENT_ROOT']) )) . '?_CAPTCHA&amp;t=' . urlencode(microtime()).'&amp;c='.$captcha_config['code'];
//        $image_src = '/' . ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
                $image_src = ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
//        $image_src =  $module.ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
                $image_src=str_replace("modules/", "", $image_src);
    } else {
        $_SERVER['WEB_ROOT'] = str_replace($_SERVER['SCRIPT_NAME'], '', $_SERVER['SCRIPT_FILENAME']);
        $image_src = substr(__FILE__, strlen( realpath($_SERVER['WEB_ROOT']) )) . '?_CAPTCHA&amp;t=' . urlencode(microtime()).'&amp;c='.$captcha_config['code'];
//        $image_src = '/' . ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
        $image_src = ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
//        $image_src = $module.ltrim(preg_replace('/\\\\/', '/', $image_src), '/');
        $image_src=str_replace("modules/", "", $image_src);
    }
//$image_src=__FILE__.$image_src;
